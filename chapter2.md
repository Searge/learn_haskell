...
![Іван](http://s3.amazonaws.com/lyah/cowboy.png)
...
`sed` бере пару та повертає її другий компонент. Ніколи б не здогадався!
